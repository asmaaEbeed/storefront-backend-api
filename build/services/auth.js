...
var authenticate = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_1 = _a.sent();
                        throw new Error("unable create user (".concat(u.email, "): ").concat(err_1));
                    case 5:
                        conn.release();
                        return [7 /*endfinally*/];
    ...
    authenticate.prototype.login = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, _a, hashed, user, isValid, token, err_2;
    ...
    authenticate.prototype.verify = function (token) {
