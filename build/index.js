...
var userModel = new users_2.makeUserModel();
dotenv.config();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    token = _a.sent();
                    isValid = userModel.verify(token);
                    console.log(isValid);
                    return [4 /*yield*/, userModel.authenticate({ email: 'mody@gmail.com', password: 'password' })];
                case 2:
                    newToken = _a.sent();
