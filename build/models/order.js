...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.create = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, newOrder, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_1 = _a.sent();
                        throw new Error("unable create order (".concat(order.status, "): ").concat(err_1));
                    case 5:
                        conn.release();
                        return [7 /*endfinally*/];
    ...
    OrderStore.prototype.showOrder = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, 5, 6]);
                        return [4 /*yield*/, connection.query('SELECT * FROM orders WHERE id = $1', [id])];
                    case 3:
                        result = _a.sent();
                        if (result.rowCount === 0)
                            throw new Error("Order ".concat(id, " is not found"));
    ...
    OrderStore.prototype.addOrderProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_4 = _a.sent();
                        throw new Error("Unable add product: ".concat(productId, " to order ").concat(orderId, ": ").concat(err_4));
                    case 5:
                        conn.release();
                        return [7 /*endfinally*/];
                    case 6: return [2 /*return*/];
    ...
    OrderStore.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
